...
if __name__ == "__main__":
    ...
    numDataPoints = 1000000  # The Number of Points to Stream into the EMG Arduino
    ...
    modelPath = "./Helper Files/Machine Learning Modules/Models/myModelKNNFull_SamArm.pkl"
